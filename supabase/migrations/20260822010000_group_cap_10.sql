-- WHONEXT UNIVERSE — raise the 團體報名 group size cap from 4 to 10
-- Paste into Supabase Dashboard > SQL Editor > New query, run once after 20260821030000.
...
declare
  ...
  v_index int;
begin
  if array_length(p_nicknames, 1) is null or array_length(p_nicknames, 1) not between 1 and 10 then
    raise exception '人數需為 1 到 10 人';
  end if;
